...
public class FloatCashEditor extends JDialog {
    ...
    public FloatCashEditor(AppView m_app, JPanel parent) throws BasicException {
     
    }

    private FloatCashEditor(Frame frame, boolean b) {
        super(frame, b);
        setBounds(x, y, 662, 562);
    }

    private FloatCashEditor(Dialog dialog, boolean b) {
        super(dialog, b);
        setBounds(x, y, 662, 562);
    }
    ...
    public static void showMessage(Component parent, PurchaseOrderReceipts PurchaseOrder, AppView m_App) throws BasicException {
        ...
        FloatCashEditor.PurchaseOrder=PurchaseOrder;
        // PurchaseOrder = (PurchaseOrderReceipts) m_App.getBean("com.sysfore.pos.purchaseorder.PurchaseOrderReceipts");
        Window window = getWindow(parent);
        FloatCashEditor myMsg;
        if (window instanceof Frame) {
            myMsg = new FloatCashEditor((Frame) window, true);
        } else {
            myMsg = new FloatCashEditor((Dialog) window, true);
        }
...
private static void showMessage(Component parent, PurchaseOrderReceipts PurchaseOrder) throws BasicException {
    ...
    public void init(PurchaseOrderReceipts PurchaseOrder, AppView m_App) throws BasicException {
        ...
        if(cashInfo.size()==0){
           ...
           java.util.List<Posinfo> list = PurchaseOrder.getPosList();
            for (Posinfo dis : list) {
                jCboPosNo.addItem(dis.getPosNo());
            }
            jCboPosNo.setSelectedIndex(-1);
        setTitle("Float Cash Setup");
        setVisible(true);
    ...
    private void initComponents() {
        ...
        jCboPosNo = new javax.swing.JComboBox();
        ...
        m_jtxtFloatAmt.setEditable(false);
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(20, 20, 20)
                .add(jCboPosNo, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 200, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
        );
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(m_LblFloatAmt, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 30, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jCboPosNo, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 24, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
        );
      ...
      String posNo = jCboPosNo.getSelectedItem().toString();
       ...
       try {
        ...
        try {
            ...
            showMessage(this, "Float cash updated successfully");
        } catch (BasicException ex) {
            Logger.getLogger(FloatCashEditor.class.getName()).log(Level.SEVERE, null, ex);
        }
        }else{
            showMsgRed(this, "Float cash is already set for POS "+posNo);
        }
     
     
}//GEN-LAST:event_jbtnSaveActionPerformed
   private void showMsgRed(FloatCashEditor aThis,String msg) {
 ...
 private JPanel getLabelGreenPanel(String msg) {
  ...
  //  panel.setBackground(Color.BLUE);
    ...
    private void showMessage(FloatCashEditor aThis, String msg) {
    ...
    private javax.swing.JComboBox jCboPosNo;
