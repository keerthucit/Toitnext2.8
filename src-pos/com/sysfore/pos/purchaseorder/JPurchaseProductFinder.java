 ...
 * @author adrianromero
 */
public class JPurchaseProductFinder extends javax.swing.JDialog {
    ...
    private JPurchaseProductFinder(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    }
    /** Creates new form JProductFinder */
    private JPurchaseProductFinder(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
    }    
    ...
    private ProductInfoExt init(DataLogicSales dlSales, int productsType) {
        ...
        PurchaseProductFilterSales jproductfilter = new PurchaseProductFilterSales(dlSales, m_jKeys);
        jproductfilter.activate();
        m_jProductSelect.add(jproductfilter, BorderLayout.CENTER);
        switch (productsType) {
            case PRODUCT_NORMAL:
                lpr = new ListProviderCreator(dlSales.getPurchaseProductListNormal(), jproductfilter);
                break;
            case PRODUCT_AUXILIAR:               
                lpr = new ListProviderCreator(dlSales.getPurchaseProductListAuxiliar(), jproductfilter);
                break;
            default: // PRODUCT_ALL
                lpr = new ListProviderCreator(dlSales.getPurchaseProductList(), jproductfilter);
                break;
    ...
    public static ProductInfoExt showMessage(Component parent, DataLogicSales dlSales, int productsType) {
        ...
        JPurchaseProductFinder myMsg;
        if (window instanceof Frame) {
            myMsg = new JPurchaseProductFinder((Frame) window, true);
        } else {
            myMsg = new JPurchaseProductFinder((Dialog) window, true);
        }
