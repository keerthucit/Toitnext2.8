 ...
 * @author mateen
 */
public class GoodsMovementProductInfo implements SerializableRead, SerializableWrite {
    ...
    public GoodsMovementProductInfo() {
    }
     ...
     * @param quantity the quantity to set
     */
    public void setUnits(double quantity) {
        this.units = units;
    }
