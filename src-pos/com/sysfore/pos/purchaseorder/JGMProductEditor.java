 ...
 * @author mateen
 */
public class JGMProductEditor extends javax.swing.JDialog {

    private GoodsMovementProductInfo m_ProdInfo;
    private boolean m_bunitsok;
    private boolean m_bpriceok;
    private GoodsMovementLine oLine;
    private AppView app;
    private double rate;
     ...
     */
    private JGMProductEditor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    }
     ...
     * Creates new form JProductLineEdit
     */
    private JGMProductEditor(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
    }

    private GoodsMovementLine init(AppView app, GoodsMovementLine oLine, int i) throws BasicException {
        ...
        setTxtFields(oLine.getTaxid(), oLine.getTaxes(), JGoodsMovement.m_jSubtotalEuros1.getText(), JGoodsMovement.m_jTotalEuros1.getText());
    ...
    private void setTxtFields(String taxid, String taxesCat, String subtotal, String total) {
        ...
        m_jSubtotal.setText(JGoodsMovement.m_jSubtotalEuros1.getText());
        m_jTotal.setText(JGoodsMovement.m_jTotalEuros1.getText());
    }
    ...
    public static GoodsMovementLine showMessage(Component parent, AppView app, GoodsMovementLine oLine, int tablePos) throws BasicException {

        Window window = getWindow(parent);

        JGMProductEditor myMsg;
        if (window instanceof Frame) {
            myMsg = new JGMProductEditor((Frame) window, true);
        } else {
            myMsg = new JGMProductEditor((Dialog) window, true);
        }
