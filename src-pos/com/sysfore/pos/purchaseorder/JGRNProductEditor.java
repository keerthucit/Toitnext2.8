 ...
 * @author mateen
 */
public class JGRNProductEditor extends javax.swing.JDialog {

    private GoodsReceiptsProductInfo m_ProdInfo;
    private boolean m_bunitsok;
    private boolean m_bpriceok;
    private GoodsReceiptsLine oLine;
    private AppView app;
    private double rate;
     ...
     */
    private JGRNProductEditor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    }
     ...
     * Creates new form JProductLineEdit
     */
    private JGRNProductEditor(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
    }

    private GoodsReceiptsLine init(AppView app, GoodsReceiptsLine oLine, int i) throws BasicException {
        ...
        m_jName.setEnabled(!app.getAppUserView().getUser().hasPermission("com.sysfore.pos.purchaseorder.JGoodsReceipts"));
        m_jPrice.setEnabled(app.getAppUserView().getUser().hasPermission("com.sysfore.pos.purchaseorder.JGoodsReceipts"));
        m_jPriceTax.setEnabled(!app.getAppUserView().getUser().hasPermission("com.sysfore.pos.purchaseorder.JGoodsReceipts"));

        setTxtFields(oLine.getTaxid(), oLine.getTaxes(), JGoodsReceipts.m_jSubtotalEuros1.getText(), JGoodsReceipts.m_jTotalEuros1.getText());
    ...
    private void setTxtFields(String taxid, String taxesCat, String subtotal, String total) {
        ...
        try {
            ...
            Logger.getLogger(JGRNProductEditor.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
           taxInfo = tInfo.get(0);
        ...
        m_jSubtotal.setText(JGoodsReceipts.m_jSubtotalEuros1.getText());
        m_jTotal.setText(JGoodsReceipts.m_jTotalEuros1.getText());
    }
    ...
    public static GoodsReceiptsLine showMessage(Component parent, AppView app, GoodsReceiptsLine oLine, int tablePos) throws BasicException {

        Window window = getWindow(parent);

        JGRNProductEditor myMsg;
        if (window instanceof Frame) {
            myMsg = new JGRNProductEditor((Frame) window, true);
        } else {
            myMsg = new JGRNProductEditor((Dialog) window, true);
        }
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel6);
        jLabel6.setBounds(10, 200, 90, 18);
        ...
        jPanel2.add(jLabel7);
        jLabel7.setBounds(10, 170, 90, 18);
