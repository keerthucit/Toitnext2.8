 ...
 * @author mateen
 */
public class PurchaseInvoiceProductInfo implements SerializableRead, SerializableWrite {
    ...
    public PurchaseInvoiceProductInfo() {
    }
