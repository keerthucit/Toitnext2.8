 ...
 * @author mateen
 */
public class JProductPurchaseLineEditor extends javax.swing.JDialog {

    private PurchaseOrderProductInfo m_ProdInfo;
    private boolean m_bunitsok;
    private boolean m_bpriceok;
    private boolean m_bDiscountok;
    private PurchaseInvoiceLine oLine;
    private AppView app;
    private double rate;
     ...
     */
    private JProductPurchaseLineEditor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    }
     ...
     * Creates new form JProductLineEdit
     */
    private JProductPurchaseLineEditor(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
    }

    private PurchaseInvoiceLine init(AppView app, PurchaseInvoiceLine oLine, int i) throws BasicException {
        ...
        setTxtFields(oLine.getTaxid(), oLine.getTaxes(), JPurchaseInvoice.m_jSubtotalEuros1.getText(), JPurchaseInvoice.m_jTotalEuros1.getText());
    ...
    private void setTxtFields(String taxid, String taxesCat, String subtotal, String total) {
        ...
        m_jDiscount.setDoubleValue(oLine.getDiscount());

        m_jPriceTax.setDoubleValue(pricePtax);
        setTaxCatName(taxInfo.getName());
        m_jTaxrate.setText(getTaxCatName());
        m_jSubtotal.setText(JPurchaseInvoice.m_jSubtotalEuros1.getText());
        m_jTotal.setText(JPurchaseInvoice.m_jTotalEuros1.getText());
    }
...
//                m_bDiscountok = false;
//            } else {
                double price = oLine.getMultiply()*oLine.getPrice();
                
                oLine.setDiscount(value);
                //double discountPrice = (price * oLine.getDiscount())*0.01;
                JPurchaseInvoiceLines.setMultiplychanged(true);
                m_bDiscountok = true;
             //   System.out.println("oline discount--"+oLine.getDiscount()+"---"+discountPrice+"==="+price);
                printTotals();
//            }
    ...
    public static PurchaseInvoiceLine showMessage(Component parent, AppView app, PurchaseInvoiceLine oLine, int tablePos) throws BasicException {

        Window window = getWindow(parent);

        JProductPurchaseLineEditor myMsg;
        if (window instanceof Frame) {
            myMsg = new JProductPurchaseLineEditor((Frame) window, true);
        } else {
            myMsg = new JProductPurchaseLineEditor((Dialog) window, true);
        }
    ...
    private void initComponents() {
        ...
        m_jDiscount = new com.openbravo.editor.JEditorDouble();
        ...
        jPanel2.add(jLabel1);
        jLabel1.setBounds(10, 110, 90, 18);

        jLabel2.setText(AppLocal.getIntString("label.units")); // NOI18N
        jPanel2.add(jLabel2);
        jLabel2.setBounds(10, 50, 90, 18);
        jDiscount.setText("Discount"); // NOI18N
        jPanel2.add(jDiscount);
        jDiscount.setBounds(10, 80, 90, 18);

        jLabel3.setText(AppLocal.getIntString("label.pricetax")); // NOI18N
        jPanel2.add(jLabel3);
        jLabel3.setBounds(10, 140, 90, 18);
        ...
        m_jDiscount.setBounds(100, 80, 240, 25);
        jPanel2.add(m_jPrice);
        m_jPrice.setBounds(100, 110, 240, 25);
        jPanel2.add(m_jPriceTax);
        m_jPriceTax.setBounds(100, 140, 240, 25);
        ...
        jPanel2.add(jLabel6);
        jLabel6.setBounds(10, 230, 90, 18);
        ...
        jPanel2.add(jLabel7);
        jLabel7.setBounds(10, 200, 90, 18);
...
//        printTotals();
    ...
    private com.openbravo.editor.JEditorDouble m_jDiscount;
