 ...
 * @author mateen
 */
public class GoodsReceiptsLine {
    ...
    public GoodsReceiptsLine(ProductInfoExt oProduct) {
    ...
    public GoodsReceiptsLine(ProductInfoExt oProduct, double dpor, double dprice, String taxid) {
        m_sProdID = oProduct.getID();
        m_sProdName = oProduct.getName();
        m_dMultiply = dpor;
        m_dPrice = dprice;
