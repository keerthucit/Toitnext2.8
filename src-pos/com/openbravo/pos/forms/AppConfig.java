...
//        m_propsconfig.setProperty("db.password", "password");        
        ...
        m_propsconfig.setProperty("machine.momoestatus", "false");
        m_propsconfig.setProperty("machine.reservationstatus", "false");
        m_propsconfig.setProperty("machine.merchantid", "");
        m_propsconfig.setProperty("machine.merchantkey", "");
        m_propsconfig.setProperty("machine.momoeserver", "");
        m_propsconfig.setProperty("machine.license", "");
