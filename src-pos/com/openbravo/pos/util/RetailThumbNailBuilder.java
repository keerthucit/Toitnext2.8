...
public class RetailThumbNailBuilder {
    ...
    public RetailThumbNailBuilder(int width, int height, Image imgdef) {
        init(width, height, imgdef,null);
      
    }
    
    public RetailThumbNailBuilder(int width, int height, String img, String labelName) {
        
        Image defimg;
        try {
            init(width, height, ImageIO.read(getClass().getClassLoader().getResourceAsStream(img)),labelName);               
        } catch (Exception fnfe) {
            init(width, height, null,null);
        }                 
    }    
    
    private void init(int width, int height, Image imgdef,String labelName) {
        m_width = width;
        m_height = height;
