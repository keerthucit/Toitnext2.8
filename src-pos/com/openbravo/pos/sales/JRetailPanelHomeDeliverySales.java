...
public class JRetailPanelHomeDeliverySales extends JRetailPanelHomeTicket {

    private CatalogSelector m_cat;
   
    /** Creates a new instance of JPanelTicketSales */
    public JRetailPanelHomeDeliverySales() {
    }
    ...
    //    super.setHomeDeliverySale("HomeDelivery");

        return JRetailTicketsBag.createTicketsBag(m_App.getProperties().getProperty("machine.ticketsbag"), m_App, this,"HomeDelivery");
    }
