...
public class JTicketsBagTicket extends JTicketsBag {
    ...
    public boolean deactivate() {
        ...
        m_ticketCopy = null;
        return true;       
        //ic postcondicion es que no tenemos ticket activado ni ticket en el panel
    }
    ...
    public void deleteTicket() {
        System.out.println("enetr deleteTicket");
        if (ticketValue != null) {
            // Para editar borramos el ticket anterior
            try {               
                m_dlSales.deleteTicket(ticketValue, m_App.getInventoryLocation());
        ...
        public void deleteTicket(TicketInfo m_ticketCopy) {
        System.out.println("enetr deleteTicket");
    ...
    private void readTicket(int iTicketid, int iTickettype) {
        ...
        try {
            ...
            if (ticket == null) {
                ...
                m_ticket = ticket;
                System.out.println("m_ticket---"+m_ticket.getDocumentNo());
                setDocumentNo(m_ticket.getDocumentNo());
