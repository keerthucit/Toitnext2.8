...
public class JRetailResettleBill extends JRetailTicketsBag {
 ...
 private DataLogicReceipts m_dlReceipts = null;
    ...
    private JRetailResettleBillEdit m_panelticketedit;
   ...
   private SentenceList senttaxcategories;
    ...
    public JRetailResettleBill(AppView app, JRetailResettleBillEdit panelticket) {
 ...
 //       m_jTicketEditor.activate();
    ...
    protected JComponent getNullComponent() {
        return this;
            ...
            private void showMessage(JRetailResettleBill aThis, String msg,Color colour) {
...
//                : m_dlSales.loadRetailTicket(iTickettype, iTicketid) ;
            ...
            if (ticket == null) {
             ...
             if(ticket.getDate().before(lineTaxStartdate)){
            ...
            Logger.getLogger(JRetailResettleBill.class.getName()).log(Level.SEVERE, null, ex);
...
//    }//GEN-LAST:event_m_jRefundActionPerformed
  ...
  private void m_jSettleActionPerformed(ActionEvent evt) {
            //m_ticket
      java.util.List<ResettlePaymentInfo> paymentList=JResettlePaymentEditor.showMessage(this, m_dlReceipts, m_ticket);
          if(paymentList != null){
              if(paymentList.size()>0){
                try {
                     m_dlSales.updatePayments(m_ticket,paymentList);
                    // m_dlSales.insertActionsLog("Resettle", m_ticket.getUser().getId(), m_App.getProperties().getPosNo(),m_ticket.getTicketId(),new Date(), m_ticket.getPlaceId(), null, paymentList.get(0).getResettleReason());
                     showMessage(this,"Bill has been resettled successfully",Color.green);
                } catch (BasicException ex) {
                Logger.getLogger(JRetailResettleBill.class.getName()).log(Level.SEVERE, null, ex);
               }
              }
