...
public class JProductLineEdit extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel3.setMinimumSize(new java.awt.Dimension(175, 240));
        jPanel3.setPreferredSize(new java.awt.Dimension(170, 240));
        jPanel3.setLayout(new java.awt.BorderLayout());

        jPanel4.setMinimumSize(new java.awt.Dimension(175, 235));
        jPanel4.setPreferredSize(new java.awt.Dimension(175, 235));
        jPanel4.setLayout(new javax.swing.BoxLayout(jPanel4, javax.swing.BoxLayout.Y_AXIS));

        m_jKeys.setPreferredSize(new java.awt.Dimension(170, 235));
        jPanel4.add(m_jKeys);
