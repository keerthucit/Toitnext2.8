...
public class TaxesLogic {
    ...
    public List<TicketTaxInfo> calculateTaxes(TicketLineInfo line) throws TaxesException {
        ...
        System.out.println("enter calculatetaxes----");
        System.out.println("line.getTaxInfo()---"+line.getTaxInfo());
        TaxesLogicElement taxesapplied = getTaxesApplied(line.getTaxInfo());
        System.out.println("after calculatetaxes");
        return calculateLineTaxes(line.getSubValue(), taxesapplied);
    }

     public List<TicketTaxInfo> calculateTaxes(TicketLineInfo line, TicketInfo ticket) throws TaxesException {
    ...
    private List<TicketTaxInfo> calculateLineTaxes(double base, TaxesLogicElement taxesapplied) {
     ...
     private List<TicketTaxInfo> calculateLineTaxes(double base, TaxesLogicElement taxesapplied,TicketInfo ticket) {
