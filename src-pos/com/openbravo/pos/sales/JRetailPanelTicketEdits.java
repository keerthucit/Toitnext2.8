...
public class JRetailPanelTicketEdits extends JRetailPanelEditTicket {
    
    private JRetailTicketCatalogLines m_catandlines;
    
    /** Creates a new instance of JPanelTicketRefunds */
    public JRetailPanelTicketEdits() {
    }
    ...
    //    super.setHomeDeliverySale("");
          super.setEditSale("Edit");
        super.activate();
    ...
    protected JRetailTicketsBag getJTicketsBag() {
        return new JRetailTicketsBagTicket(m_App, this);
    }

    protected Component getSouthComponent() {

        m_catandlines = new JRetailTicketCatalogLines(m_App, this,
