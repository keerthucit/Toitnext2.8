...
//    }    
    ...
    String latestParentTax="";
        ...
        return defaulttax;
          ...
          public TaxInfo getExemptTaxInfo(String tcid, CustomerInfoExt customer,String isTakeAway) {
    String latestParentTax="";
        try {
            latestParentTax = dlSales.getLatestExemptParentTax(tcid,isTakeAway);
        } catch (BasicException ex) {
            Logger.getLogger(RetailTaxesLogic.class.getName()).log(Level.SEVERE, null, ex);
        }
