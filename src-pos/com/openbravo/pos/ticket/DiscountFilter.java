...
System.out.println("inside DiscountFilter");
        initComponents();
    }
    ...
    public void init(AppView app) {
        ...
        m_sentcat = dlSales.getDiscountCategoryList();
    ...
    public void activate() throws BasicException {
      ...
      // AutoCompletion.enable(m_jCategory);
    ...
    private void initComponents() {
        ...
        add(m_jCategory, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 10, 200, 20));

        jLabelCat.setText("Category");
        jLabelCat.setPreferredSize(new java.awt.Dimension(110, 14));
        add(jLabelCat, new org.netbeans.lib.awtextra.AbsoluteConstraints(23, 3, 107, 30));
 ...
 private void showMsg(DiscountFilter aThis, String msg) {
