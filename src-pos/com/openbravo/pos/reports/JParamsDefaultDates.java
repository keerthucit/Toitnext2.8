...
public class JParamsDefaultDates extends javax.swing.JPanel implements ReportEditorCreator {
    public static final String DATE_FORMAT_NOW = "d MMM, yyyy hh:mm:ss a ";
...
calt.set(Calendar.SECOND, 0);
 ...
 private void showMsg(JParamsDefaultDates aThis, String msg) {
    ...
    public Object createValue() throws BasicException {
        ...
        if(jTxtStartDate.getText().equals(""))
         {
           jTxtStartDate.setText(startTime()); 
         String startDateVal= jTxtStartDate.getText();
         
          Date date=null;
            try {
                date = sdf.parse(startDateVal);
