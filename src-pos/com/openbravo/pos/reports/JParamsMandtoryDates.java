...
public class JParamsMandtoryDates extends javax.swing.JPanel implements ReportEditorCreator {
    public static final String DATE_FORMAT_NOW = "d MMM, yyyy hh:mm:ss a ";
     Calendar cal = Calendar.getInstance();
    SimpleDateFormat sdf = new SimpleDateFormat(DATE_FORMAT_NOW);
    
   /** Creates new form JParamsClosedPos */
    public JParamsMandtoryDates() {
        initComponents();
    }
 ...
 private void showMsg(JParamsMandtoryDates aThis, String msg) {
    ...
    public Object createValue() throws BasicException {
       ...
       // if(jTxtStartDate.getText().equals(""))
        // {
      //      showMsg(this,"Please Select The From Date");
          //  return null;
     //   }
      // else
            if(jTxtEndDate.getText().equals(""))
        {
          ...
          Date date=null;
            try {
                ...
                Logger.getLogger(JParamsMandtoryDates.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void initComponents() {
        ...
        add(jLabel3);
        jLabel3.setBounds(20, 20, 110, 14);
