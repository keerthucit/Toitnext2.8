...
public class JParamsDatesBeforeJune extends javax.swing.JPanel implements ReportEditorCreator {
   AppView m_app;
   Logger logger = Logger.getLogger("MyLog");
    /**
     * Creates new form JParamsClosedPos
     */
    public JParamsDatesBeforeJune() {
        initComponents();
    ...
    public Object createValue() throws BasicException {
        ...
        if ((jTxtStartDate.getText().equals("") || jTxtEndDate.getText().equals(""))) {
            ...
            return "";
        } else if (erpTaxDate.before((Date) startdate)&& !m_app.getProperties().getStoreName().equals("TPR") ) {
            showMessage(this, "Please Refer New Report");
            return "";
        }else if (erpTaxDate.before((Date) enddate)&& !m_app.getProperties().getStoreName().equals("TPR") ) {
            showMessage(this, "Please Refer New Report");
            return "";
    ...
    private void showMessage(JParamsDatesBeforeJune aThis, String msg) {
