...
public class KotStatusFilter extends javax.swing.JPanel implements ReportEditorCreator {
    
   // private SentenceList m_sentcat;
    private ComboBoxValModel m_StatusModel;
     private String selectedval=null;
    /** Creates new form JQBFProduct */
    public KotStatusFilter() {
    ...
    //    m_sentcat = dlSales.getCategoriesList();
        m_StatusModel = new ComboBoxValModel();
    ...
    public void activate() throws BasicException {
        ...
        statuslist.add("KOT Order");
        statuslist.add("Cancel Order");
//        catlist.add(0, null);
     m_StatusModel = new ComboBoxValModel(statuslist);
        m_jstatus.setModel(m_StatusModel);
...
// 
    ...
    private void m_jstatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jstatusActionPerformed
        ...
        if(selectedval.equals("KOT Order"))
        {
           selectedval="N";
        }
        else
    ...
    public Object createValue() throws BasicException {
            return new Object[] {
                  m_StatusModel.getSelectedText() == null ? QBFCompareEnum.COMP_NONE : QBFCompareEnum.COMP_EQUALS, selectedval,
                QBFCompareEnum.COMP_NONE, null         
            };
