...
public class CustomerInfoExt extends CustomerInfo {
 ...
 private String Receivable;
    ...
    public boolean getIsCreditcustomer() {
     ...
     * @param iscustomer the iscustomer to set
     */
    public void setIsCreditcustomer(boolean isCreditcustomer) {
    ...
    /**
     * @param shiftaddress the shiftaddress to set
     */
