...
public abstract class Formats {
    ...
    public final static Formats DoubleValue = new FormatsDoubleValue();
    public final static Formats DATEFORMAT = new DtFormat();
    ...
    private static NumberFormat m_Doubleformat = new DecimalFormat("###0.00");
    ...
    private static DateFormat m_date = new SimpleDateFormat("dd-MM-yyyy");
    ...
    public static void setIntegerPattern(String pattern) {
      ...
      public String formatStoreValue(Object value) {
        if (value == null) {
            return "";
        } else {
            String args[]=null;
                 AppConfig config = new AppConfig(args);
                  config.load();
                String store =config.getProperty("machine.StoreName");
            return store;
        }
    }
    ...
    public static void setDoubleValuePattern(String pattern) {
        if (pattern == null || pattern.equals("")) {
            m_Doubleformat = new DecimalFormat("#,##0.00");
        } else {
            m_Doubleformat = new DecimalFormat(pattern);
        }
    }
    ...
    public static void setDateTimePattern(String pattern) {
     ...
     private static final class DtFormat extends Formats {
        protected String formatValueInt(Object value) {
            return m_date.format((Date) value);
        }
        protected Object parseValueInt(String value) throws ParseException {
            try {
                return m_date.parse(value);
            } catch (ParseException e) {
    ...
    private static final class FormatsPERCENT extends Formats {       
        ...
        private static final class FormatsDoubleValue extends Formats {
        protected String formatValueInt(Object value) {
            return m_Doubleformat.format(DoubleUtils.fixDecimals((Number) value)); // quickfix for 3838
        }
        protected Object parseValueInt(String value) throws ParseException {
