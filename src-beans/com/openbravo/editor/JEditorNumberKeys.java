...
public class JEditorNumberKeys extends javax.swing.JPanel implements EditorKeys {
...
//        m_jMode.addActionListener(new MyKeyNumberListener('\u0010')); 
    ...
    public void setMode(int iMode) {
        switch (iMode) {
            case MODE_DOUBLE:
                m_bMinus = false;
                m_bKeyDot = true;
                System.out.println("keys testing 1");
                keysavailable = SET_DOUBLE;
                 System.out.println("keys testing 2");  
                break;
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(181, 240));
        setPreferredSize(new java.awt.Dimension(175, 240));
        setLayout(new java.awt.GridBagLayout());

        m_jKey0.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/0.png"))); // NOI18N
        m_jKey0.setFocusPainted(false);
        m_jKey0.setFocusable(false);
        m_jKey0.setMargin(new java.awt.Insets(8, 16, 8, 16));
        m_jKey0.setMaximumSize(new java.awt.Dimension(113, 46));
        m_jKey0.setMinimumSize(new java.awt.Dimension(145, 62));
        m_jKey0.setPreferredSize(new java.awt.Dimension(109, 42));
        ...
        m_jKey1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/1Numeric.png"))); // NOI18N
        m_jKey1.setFocusPainted(false);
        m_jKey1.setFocusable(false);
        m_jKey1.setMargin(new java.awt.Insets(8, 16, 8, 16));
        m_jKey1.setMaximumSize(new java.awt.Dimension(55, 46));
        m_jKey1.setMinimumSize(new java.awt.Dimension(87, 62));
        m_jKey1.setPreferredSize(new java.awt.Dimension(51, 47));
        ...
        m_jKey4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/4Numeric.png"))); // NOI18N
        m_jKey4.setFocusPainted(false);
        m_jKey4.setFocusable(false);
        m_jKey4.setMargin(new java.awt.Insets(8, 16, 8, 16));
        m_jKey4.setMaximumSize(new java.awt.Dimension(55, 46));
        m_jKey4.setMinimumSize(new java.awt.Dimension(87, 62));
        m_jKey4.setPreferredSize(new java.awt.Dimension(51, 42));
        ...
        m_jKey7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/7Numeric.png"))); // NOI18N
        m_jKey7.setFocusPainted(false);
        m_jKey7.setFocusable(false);
        m_jKey7.setMargin(new java.awt.Insets(8, 16, 8, 16));
        m_jKey7.setMaximumSize(new java.awt.Dimension(55, 46));
        m_jKey7.setMinimumSize(new java.awt.Dimension(87, 62));
        m_jKey7.setPreferredSize(new java.awt.Dimension(51, 42));
        ...
        m_jCE.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/ce.png"))); // NOI18N
        m_jCE.setFocusPainted(false);
        m_jCE.setFocusable(false);
        m_jCE.setMargin(new java.awt.Insets(8, 16, 8, 16));
        m_jCE.setMaximumSize(new java.awt.Dimension(113, 46));
        m_jCE.setMinimumSize(new java.awt.Dimension(145, 62));
        m_jCE.setPreferredSize(new java.awt.Dimension(109, 42));
        ...
        m_jMinus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/maines.png"))); // NOI18N
        m_jMinus.setFocusPainted(false);
        m_jMinus.setFocusable(false);
        m_jMinus.setMargin(new java.awt.Insets(8, 16, 8, 16));
        m_jMinus.setMaximumSize(new java.awt.Dimension(55, 46));
        m_jMinus.setMinimumSize(new java.awt.Dimension(87, 62));
        ...
        m_jKey9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/9Numeric.png"))); // NOI18N
        m_jKey9.setFocusPainted(false);
        m_jKey9.setFocusable(false);
        m_jKey9.setMargin(new java.awt.Insets(8, 16, 8, 16));
        m_jKey9.setMaximumSize(new java.awt.Dimension(55, 46));
        m_jKey9.setMinimumSize(new java.awt.Dimension(87, 62));
        m_jKey9.setPreferredSize(new java.awt.Dimension(51, 42));
        ...
        m_jKey8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/8Numeric.png"))); // NOI18N
        m_jKey8.setFocusPainted(false);
        m_jKey8.setFocusable(false);
        m_jKey8.setMargin(new java.awt.Insets(8, 16, 8, 16));
        m_jKey8.setMaximumSize(new java.awt.Dimension(55, 46));
        m_jKey8.setMinimumSize(new java.awt.Dimension(87, 62));
        m_jKey8.setPreferredSize(new java.awt.Dimension(51, 42));
        ...
        m_jKey5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/5Numeric.png"))); // NOI18N
        m_jKey5.setFocusPainted(false);
        m_jKey5.setFocusable(false);
        m_jKey5.setMargin(new java.awt.Insets(8, 16, 8, 16));
        m_jKey5.setMaximumSize(new java.awt.Dimension(55, 46));
        m_jKey5.setMinimumSize(new java.awt.Dimension(87, 62));
        m_jKey5.setPreferredSize(new java.awt.Dimension(51, 42));
        ...
        m_jKey6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/6Numeric.png"))); // NOI18N
        m_jKey6.setFocusPainted(false);
        m_jKey6.setFocusable(false);
        m_jKey6.setMargin(new java.awt.Insets(8, 16, 8, 16));
        m_jKey6.setMaximumSize(new java.awt.Dimension(55, 46));
        m_jKey6.setMinimumSize(new java.awt.Dimension(87, 62));
        m_jKey6.setPreferredSize(new java.awt.Dimension(51, 42));
        ...
        m_jKey3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/3Numeric.png"))); // NOI18N
        m_jKey3.setFocusPainted(false);
        m_jKey3.setFocusable(false);
        m_jKey3.setMargin(new java.awt.Insets(8, 16, 8, 16));
        m_jKey3.setMaximumSize(new java.awt.Dimension(55, 46));
        m_jKey3.setMinimumSize(new java.awt.Dimension(87, 62));
        m_jKey3.setPreferredSize(new java.awt.Dimension(51, 42));
        ...
        m_jKey2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/2Numeric.png"))); // NOI18N
        m_jKey2.setFocusPainted(false);
        m_jKey2.setFocusable(false);
        m_jKey2.setMaximumSize(new java.awt.Dimension(55, 46));
        m_jKey2.setMinimumSize(new java.awt.Dimension(55, 46));
        m_jKey2.setPreferredSize(new java.awt.Dimension(51, 42));
        ...
        m_jKeyDot.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/dot.png"))); // NOI18N
        m_jKeyDot.setFocusPainted(false);
        m_jKeyDot.setFocusable(false);
        m_jKeyDot.setMargin(new java.awt.Insets(8, 16, 8, 16));
        m_jKeyDot.setMaximumSize(new java.awt.Dimension(55, 46));
        m_jKeyDot.setMinimumSize(new java.awt.Dimension(87, 62));
